...
/**
 * @link https://github.com/mtdowling/cron-expression 出处
 * 
 */
...
class Cron_CronExpression {
    ...
    public static function factory($expression, Cron_FieldFactory $fieldFactory = null) {
        ...
        return new self($expression, $fieldFactory ? $fieldFactory : new Cron_FieldFactory());
    }
     ...
     * @return \DateTime
     * @throws \RuntimeException on too many iterations
     * @see Cron\Cron_CronExpression::getNextRunDate
     */
